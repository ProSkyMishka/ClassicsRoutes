...
//@objc
//private func sendCodeWasPressed() {
//        let smtp = SMTP(
//            hostname: "smtp.gmail.com",        // SMTP server address
//            email: "mprozorskiy@mail.ru",      // username to login
//            password: "password"               // password to login
//        )
//
//        let drLight = Mail.User(name: "Dr. Light", email: "mihailprozorskiy@gmail.com")
//        let megaman = Mail.User(name: "Megaman", email: "sonipr108@mail.ru")
//
//        let mail = Mail(
//            from: drLight,
//            to: [megaman],
...
//    @objc
//    private func sendButtonWasPressed() {
//        sendButton.isHidden = true
//        problemButton.isHidden = false
//    }
//
//    @objc
//    private func problemButtonWasPressed() {
//    }
...
//
//        sendButton.addTarget(self, action: #selector(sendButtonWasPressed), for: .touchUpInside)
//    }

//    private func configureProblemButton() {
//        problemButton.isHidden = true
//
//        problemButton.setTitle("Код не пришел", for: .normal)
//
//        problemButton.addTarget(self, action: #selector(problemButtonWasPressed), for: .touchUpInside)
//    }
